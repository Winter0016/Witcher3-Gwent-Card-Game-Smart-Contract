...
contract HelperConfig is CodeConstants, Script {
        ...
        returns (NetworkConfig memory sepoliaNetworkConfig)
    {
        sepoliaNetworkConfig = NetworkConfig({
            ...
            account: 0xe80a4971796D754c2036aC3bf8814a542467c094
        });
    }
    ...
    function getArbitrumSepoliaConfig()
        public
        pure
        returns (NetworkConfig memory arbitrumNetworkConfig)
    {
    ...
    function getOrCreateAnvilEthConfig() public returns (NetworkConfig memory) {
        ...
        vrfCoordinatorV2_5Mock.fundSubscription(
            subscriptionId,
            uint96(MOCK_BASE_FEE * 100) // Fund with plenty of mock LINK
        );
        vm.stopBroadcast();
